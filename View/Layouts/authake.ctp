...
<head>
	<title>
		<?php echo __d('authake', 'CakePHP: the rapid development php framework:'); ?>
...
<body>
	<div id="container">
		<div id="header">
			<h1><?php echo $this->Html->link(__d('authake', 'CakePHP: the rapid development php framework'), '/'); ?></h1>
		</div>
		<div id="content">
			<?php
		...
		<div id="footer">
			<?php echo $this->Html->link(
							$this->Html->image('cake.power.gif', array('alt'=> __d('authake', "CakePHP: the rapid development php framework"), 'border'=>"0")),
